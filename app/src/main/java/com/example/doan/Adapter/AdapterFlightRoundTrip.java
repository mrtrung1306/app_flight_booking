...
public class AdapterFlightRoundTrip extends RecyclerView.Adapter<AdapterFlightRoundTrip.ViewHolder> {

    public List<Flight> flightList;
    private IClickFlightRoundTrip iClickFlightRoundTrip;
    ...
    public AdapterFlightRoundTrip(List<Flight> flightList, IClickFlightRoundTrip listener){
        this.flightList = flightList;
        this.iClickFlightRoundTrip = listener;
    }
    @NonNull
    @Override
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View flightView= inflater.inflate(R.layout.item_flight_round_trip,parent,false);
        AdapterFlightRoundTrip.ViewHolder viewHolder = new AdapterFlightRoundTrip.ViewHolder(flightView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterFlightRoundTrip.ViewHolder holder, int position) {
        ...
        holder.btnPhoThong.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                iClickFlightRoundTrip.onFlightClick(temp);
