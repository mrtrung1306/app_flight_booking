...
public class AdapterSeatReturnInformation extends RecyclerView.Adapter<AdapterSeatReturnInformation.ViewHolder> {
    ...
    public AdapterSeatReturnInformation(Context context, int availableSeats, IClickItemSeatInformation iClickItemSeatInformation){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        AdapterSeatReturnInformation.ViewHolder viewHolder = new AdapterSeatReturnInformation.ViewHolder(passengerView);
        return viewHolder;
    }
    ...
    private void clickOpenBottomSheetSeat(){
        BottomSheetSeat bottomSheetSeat = new BottomSheetSeat(objFlight,passengerList,availableSeats,seatsList,adapterSeatInformation,this, new IClickSeat() {
            @Override
